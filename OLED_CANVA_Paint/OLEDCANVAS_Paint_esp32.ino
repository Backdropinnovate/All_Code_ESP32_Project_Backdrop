...
// Set these:
const char* ssid     = "Adarsha";
const char* password = "adarsha@2006";
...
<title>Canvas_OLED Studio</title>
<style>
  :root {
    ...
    if (info->opcode == WS_BINARY) {
      ...
      if (info->final) {
        ...
        if (rx_accept && info->len == (SCREEN_WIDTH*SCREEN_HEIGHT/8)) {
          ...
          display.drawBitmap(0, 0, frameBuf, SCREEN_WIDTH, SCREEN_HEIGHT, SH110X_WHITE);
          display.display();
